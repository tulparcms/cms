    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                <!-- Dashboards -->
                <?php
                $system_menu = TCMS()->applyFilters('system_menu', [], []);
                ?>
                @if($system_menu)
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        <i class="menu-icon tf-icons ti ti-smart-home"></i>
                        <div data-i18n="Tulpar CMS">Tulpar CMS</div>
                        <div class="badge bg-primary rounded-pill ms-auto">5</div>
                    </a>
                    <ul class="menu-sub">
                        @foreach($system_menu as $menuItem)
                            <li id="{{ $menuItem->id }}" class="menu-item {{ $menuItem->class }}">
                ...
                <li class="menu-item active open">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <div data-i18n="Eklentiler">Eklentiler</div>
                    </a>

                        <?php
                        $admin_menu = TCMS()->applyFilters('admin_menu', [], []);
                        ?>
                    @if($admin_menu)
                    <ul class="menu-sub">
...
<script src="{{ tcms_asset('tcms.js') }}"></script>
@yield('footer')
